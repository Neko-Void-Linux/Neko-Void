...
build_iso() {
    ...
    sudo ./mklive.sh -a x86_64 -r https://github.com/xlibre-void/xlibre/releases/latest/download -r https://sourceforge.net/projects/neko-void/files/repo  -r https://repo-default.voidlinux.org/current/nonfree  -r https://repo-default.voidlinux.org/current/multilib/nonfree -r https://repo-default.voidlinux.org/current/multilib -r https://codeberg.org/javiercplus/Neko-Wizard/releases/download/repo -r https://raw.githubusercontent.com/Makrennel/hyprland-void/repository-x86_64-glibc -i gzip -s zstd "${cmd_args[@]}"
}
